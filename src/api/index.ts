...
export const retrivePopularMovies = (page : number = 1) => axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=7186072bde2dd099c79ca5f770428be1&language=en-US&page=${page}`).then(({data}) => data); 
...
export const retriveSearchMovies = (page: number = 1, search : string) => axios.get(`https://api.themoviedb.org/3/search/movie?api_key=7186072bde2dd099c79ca5f770428be1&page=${page}&query=${search}`).then(({data}) => data)